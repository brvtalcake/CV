...
\usepackage[
    pdftitle={Axel PASCON's CV},
    pdfauthor={Axel PASCON},
...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Axel PASCON
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:axlpascon@gmail.com}{axlpascon@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+33-6-95-32-32-50}{06 95 32 32 50}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://brvtalcake.github.io/}{brvtalcake.github.io}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/axel-pascon-nullware}{linkedin.com/in/axel-pascon-nullware}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/brvtalcake}{github.com/brvtalcake}}%
    \end{header}
    ...
    \section{Publications}
        ...
        \begin{samepage}
            ...
            \begin{onecolentry}
                \mbox{Frodo Baggins}, \mbox{\textbf{\textit{Axel PASCON}}}, \mbox{Samwise Gamgee}
